...
class Auth extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->lang->load('auth');
                ...
                $this->load->view('navbar',array('categorie'=>'auth'));
	}
...
// log the user in
		...
		if ($this->form_validation->run() == true)
		{
			...
			if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember))
			{
				...
				$this->session->set_flashdata('message', $this->ion_auth->messages());
                                ...
                                $refered = $this->session->userdata('refered_from');
                                $this->session->unset_userdata('refered_from');
                                
				redirect($refered,"refresh");
	...
	function create_user()
    {
        ...
        else
        {
            ...
            $this->data['default_group'] = $this->config->item('default_group','ion_auth');
