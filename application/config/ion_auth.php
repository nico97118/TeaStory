 ...
 */
$config['site_title']                 = "Tea Story";              // Site Title, example.com
$config['admin_email']                = "ftruphemus@orange.com";   // Admin Email, admin@example.com
$config['default_group']              = 'membre';                   // Default group, use name
